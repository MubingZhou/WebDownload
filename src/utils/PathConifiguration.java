...
public class PathConifiguration {
	...
	public static String ALL_TRADING_DATE_PATH = STOCK_DATA_ROOT_PATH + "\\all trading date - hk.csv" ;
	...
	public void updatePathStr() {
		ALL_TRADING_DATE_PATH = STOCK_DATA_ROOT_PATH + "\\all trading date - hk.csv" ;
